      ...
      <form method="post" action="${pageContext.request.contextPath}/admin/addFilm">
         <table class="table table-hover">
            <tr>
               <td>title</td>
               <td>
                  <input type="text" name="film.title" id="title" class="form-control"><!-- FilmForm.film.title로 들어감. -->
               </td>
            </tr>
            <tr>
               <td>category</td>
            ...
            <tr>
               ...
               <td>
                  <input type="text" name="film.rentalDuration" id="rentalDuration" value="3" class="form-control">               
               </td>
            </tr>
            <tr>
               <td>rentalRate</td>
               <td>
                  <input type="text" name="film.rentalRate" id="rentalRate" value="4.99" class="form-control">
               </td>
            </tr>
            <tr>
               <td>length</td>
            ...
            <tr>
               ...
               <td>
                  <input type="text" name="film.replacementCost" id="replacementCost" value="19.99" class="form-control">
               </td>
            </tr>
            <tr>
               <td>rating</td>
